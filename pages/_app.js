...
function MyApp({ Component, pageProps }) {
  ...
  header === "fixed" && scrollPosition > 10
    ? header_ && header_[0] && header_[0].classList.add("is-fixed")
    : header_ && header_[0] && header_[0].classList.remove("is-fixed");
	
  return (
    <>
		<Head>
			<title>Loudspeaker One - Your Only Marketing Voice</title>
			<link rel="icon" type="image/png" sizes="16x16" href="/images/loudspeaker-favicon.png"/>
        </Head>	
