...
function Quote() {
	return (
		<>
			<section id="contact-us" className="content-inner" style={{ "backgroundImage": "url(images/background/bg1.png)" }}>
					...
					<div className="row align-items-center">
						<div className="col-xl-6 col-lg-7 m-b30 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
							<div className="section-head style-1">
								...
								<h2 className="title">Feel Free To Talk With Us. We Are Always Here To Help.</h2>
							</div>
								...
								<div className="row">
									...
									{/* <div className="col-sm-6">
										<div className="input-group">
											...
											<input name="dzOther[phone]" type="text" required className="form-control" placeholder="Phone No. (Optional)" />
										</div>
									</div>
									<div className="col-sm-6">
										<div className="input-group">
									...
									<div className="col-sm-12 mt-2">
										<button name="submit" type="submit" value="Submit" className="btn btn-primary d-inline-flex align-items-center"><i className="fa fa-angle-right m-r10"></i>Send</button>
									</div>
								</div>
							</form>
						</div>
						<div className="col-xl-6 col-lg-5 m-b30 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.4s">
							<div className="dlab-media cf-r-img">
								<img src="images/homepage/customer-support.png" className="move-1" alt="" />
							</div>
						</div>
					</div>
				</div>
